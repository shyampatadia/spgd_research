...
% Allow pages to end short instead of being vertically justified -- this
% is the main fix for "huge gap before a figure that didn't fit".
\raggedbottom

% Tighten the white space around floats (default \article spacing is
% generous and causes visible gaps especially for [H] figures).
...
\author{%
  ...
  \small MA 551: Computational Statistics
}
